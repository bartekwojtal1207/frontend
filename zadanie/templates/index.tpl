                ...
                {foreach $products as $keyvar=>$itemvar}
                    <div class="slider__item--products">
                        <div class="slider__item--products__price--container">
                            ...
                            {if isset($itemvar['discount'])}
                                <span class="price--container__price--previuos">
                                    {(($itemvar['discount']/100) * $itemvar['price']) + $itemvar['price'] }zł
                                </span>
                            {/if}

                        </div>
                        <img src="./{$itemvar['image']}" alt="product"
                             class="img img-fluid slider__item--products__photo">
                        ...
                        <a href="{$itemvar['link']}" role="button"
                           class="btn add-to-cart-product slider__item--products__btn--buy">kup teraz
                        </a>
                    </div>
                {/foreach}
